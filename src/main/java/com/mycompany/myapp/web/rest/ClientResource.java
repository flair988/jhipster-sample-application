...
public class ClientResource {
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                if (client.getItemId() != null) {
                    existingClient.setItemId(client.getItemId());
                }
                if (client.getItemName() != null) {
                    existingClient.setItemName(client.getItemName());
                }
                if (client.getBoardId() != null) {
                    existingClient.setBoardId(client.getBoardId());
                }
                if (client.getSubItems() != null) {
                    existingClient.setSubItems(client.getSubItems());
                }
                if (client.getKingdeeId() != null) {
                    existingClient.setKingdeeId(client.getKingdeeId());
                }
                if (client.getCustomerName() != null) {
                    existingClient.setCustomerName(client.getCustomerName());
                }
                if (client.getCustomerCode() != null) {
                    existingClient.setCustomerCode(client.getCustomerCode());
                }
                if (client.getCustomerFrenceName() != null) {
                    existingClient.setCustomerFrenceName(client.getCustomerFrenceName());
                }
