<template>
  <div>
    <h2 id="page-heading" data-cy="MondayUserHeading">
      <span v-text="t$('jhipsterSampleApplicationApp.mondayUser.home.title')" id="monday-user-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jhipsterSampleApplicationApp.mondayUser.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'MondayUserCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('jhipsterSampleApplicationApp.mondayUser.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && mondayUsers && mondayUsers.length === 0">
      <span v-text="t$('jhipsterSampleApplicationApp.mondayUser.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="mondayUsers">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.mondayUser.mondayId')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.mondayUser.name')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.mondayUser.email')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.mondayUser.url')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      ...
      <div class="modal-body">
        <p id="jhi-delete-mondayUser-heading" v-text="t$('jhipsterSampleApplicationApp.mondayUser.delete.question', { id: removeId })"></p>
      </div>
