    ...
    if (this.client.id) {
      this.clientService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationApp.client.updated', { param: param.id });
      ...
      this.clientService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterSampleApplicationApp.client.created', { param: param.id });
