<template>
  <div>
    <h2 id="page-heading" data-cy="ProductTaxmonomyHeading">
      <span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.home.title')" id="product-taxmonomy-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ProductTaxmonomyCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && productTaxmonomies && productTaxmonomies.length === 0">
      <span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="productTaxmonomies">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.itemId')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.kingdeeId')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.itemName')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.groupName')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.parentGroupName')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.subGroupName')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplicationApp.productTaxmonomy.description')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
